...
{
    public static DisplayInfo DisplayInfo => Xamarin.Essentials.DeviceDisplay.MainDisplayInfo;

    public static bool KeepScreenOn => Xamarin.Essentials.DeviceDisplay.KeepScreenOn;
